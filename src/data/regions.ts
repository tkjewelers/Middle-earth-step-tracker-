...
export const REGIONS: Region[] = [
  ...
  { name: 'oldforest',    displayName: 'Old Forest',       x: -38, z: -5,  fontSize: 2.5 },
  ...
  { name: 'trollshaws',   displayName: 'Trollshaws',       x: -2,  z: -14, fontSize: 3 },
  { name: 'eregion',      displayName: 'Eregion',          x: 10,  z: 5,   fontSize: 3 },
  { name: 'misty',        displayName: 'Misty Mountains',  x: 16,  z: -5,  fontSize: 3 },
  { name: 'dimrill',      displayName: 'Dimrill Dale',     x: 22,  z: 8,   fontSize: 2 },
  { name: 'lorien',       displayName: 'Lothlórien',       x: 28,  z: 22,  fontSize: 3 },
  { name: 'fangorn',      displayName: 'Fangorn',          x: 16,  z: 30,  fontSize: 3 },
  ...
  { name: 'brownlands',   displayName: 'Brown Lands',      x: 44,  z: 26,  fontSize: 2.5 },
  { name: 'bluemtns',     displayName: 'Blue Mountains',   x: -72, z: -10, fontSize: 2.5 },
  { name: 'nancurunir',   displayName: 'Nan Curunír',      x: 18,  z: 30,  fontSize: 2 },
];
